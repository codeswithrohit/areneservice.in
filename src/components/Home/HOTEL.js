...
<div className="w-6 lg:w-12 h-0.5 lg:h-1.5 rounded-full bg-[#43d3b0] ">
</div   >Nearest Hotel Property<div className="w-6 lg:w-12 h-0.5 lg:h-1.5 rounded-full bg-[#43d3b0]">
</div>
</div>
   ...
   <div key={i}>
   <span className="price text-xs font-bold ">{i + 1}. {property.type} - {property.price}/Day</span>
</div>
))}

...
<div className="w-6 lg:w-12 h-0.5 lg:h-1.5 rounded-full bg-[#43d3b0] ">
</div   >Nearest PG<div className="w-6 lg:w-12 h-0.5 lg:h-1.5 rounded-full bg-[#43d3b0]">
</div>
</div>
    ...
    filteredData
      ...
      .slice(0, 4) // Take only the first three items after sorting
      .map((item, index) => (
        <div key={item.id} className="w-full cursor-pointer bg-gray-100 dark:bg-gray-800 border-gray-800 shadow-md hover:shadow-lg rounded-md">

    ...
    <div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-8">
        <div class="xl:col-span-2">
          <a href='javascript:void(0)'><img src="https://www.areneservices.in/public/front/images/property-logo.png" alt="logo" class='w-24' /></a>
          <ul class="mt-10 flex space-x-6">
            <li>
              <a href='javascript:void(0)'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" class="fill-black hover:fill-[#10b981] w-6 h-6"
                  viewBox="0 0 24 24">
            ...
            <li>
              <a href='javascript:void(0)'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                  class="fill-black hover:fill-[#10b981] w-6 h-6" viewBox="0 0 24 24">
                  <path fill-rule="evenodd"
        ...
        <div>
          <h4 class="text-black font-semibold text-lg relative max-sm:cursor-pointer">Buy Property <svg
            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
            class="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
            <path
              d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
        ...
        <div>
          <h4 class="text-black font-semibold text-lg relative max-sm:cursor-pointer">Rent Property<svg
            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
            class="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
            <path
              d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
        ...
        <div>
          <h4 class="text-black font-semibold text-lg relative max-sm:cursor-pointer">Hotel <svg
            xmlns="http://www.w3.org/2000/svg" width="16px" height="16px"
            class="sm:hidden absolute right-0 top-1 fill-[#d6d6d6]" viewBox="0 0 24 24">
            <path
              d="M12 16a1 1 0 0 1-.71-.29l-6-6a1 1 0 0 1 1.42-1.42l5.29 5.3 5.29-5.29a1 1 0 0 1 1.41 1.41l-6 6a1 1 0 0 1-.7.29z"
      ...
      <div class="md:flex md:item-center mt-8">
        ...
        <p class='text-black text-sm ml-auto max-md:mt-5'>Copyright © 2024<a href='https://www.areneservices.in/'
          target='_blank' class="hover:underline mx-1">Arene Services</a>All Rights Reserved.</p>
      </div>
    </footer>
    </div>
  )

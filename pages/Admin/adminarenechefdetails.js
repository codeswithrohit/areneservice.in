...
console.log('booking',bookingData)
  ...
  return (
    <div className='min-h-screen py-12' >
          <AdminNavbar />
        <div className="lg:ml-64  px-4 sm:px-6 lg:px-8  my-4 sm:my-10">
...
<div class="mt-6 overflow-x-auto">
  <table class="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
    <thead class="bg-gray-50 dark:bg-gray-800">
      <tr>
        <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Thalli Name</th>
        <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Ingredients</th>
        ...
        <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">No. of Thalli Available</th>
        <th scope="col" class="px-3 py-2 text-right text-xs font-medium text-gray-500 uppercase">Amount Paid</th>
      </tr>
    </thead>
    <tbody class="divide-y divide-gray-200">
      <tr>
        <td class="px-3 py-2 whitespace-nowrap">{bookingData.thaliname}</td>
        <td class="px-3 py-2 whitespace-nowrap">{bookingData.Ingredients}</td>
        ...
        <td class="px-3 py-2 whitespace-nowrap">₹ {bookingData.Foodcharge}</td>
        <td class="px-3 py-2 whitespace-nowrap">{bookingData.noofthalli}</td>
    ...
    <table class="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
      <thead class="bg-gray-50 dark:bg-gray-800">
        <tr>
          <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Thalli Name</th>
          <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Ingredients</th>
          <th scope="col" class="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">No. of Thalli</th>
      ...
      <tbody class="divide-y divide-gray-200">
        {bookingData.orderHistory.map((history, index) => (
          <tr key={index}>
            <td class="px-3 py-2 whitespace-nowrap">{history.thalliName}</td>
            <td class="px-3 py-2 whitespace-nowrap">{history.ingredients}</td>
            <td class="px-3 py-2 whitespace-nowrap">{history.noOfThalli}</td>

...
const Askuserinfo = () => {
  ...
  return (
    <div className="w-full bg-emerald-100 p-10">
  ...
  <div className="flex-shrink-0 w-full  md:mr-12 h-44 sm:h-32 sm:w-32 sm:mb-0">
   ...
   <button onClick={handleSubmitStep1} role="submit"  className="flex items-center justify-center py-4 px-7 focus:outline-none bg-red-100 border rounded border-red-700 mt-7 md:mt-14 hover:bg-red-400  focus:ring-2 focus:ring-offset-2 focus:ring-red-700">

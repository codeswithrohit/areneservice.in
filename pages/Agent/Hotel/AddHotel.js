...
const AddHotel = ({handleCloseAllInputFormats}) => {
...
<div className="  grid grid-cols-1 lg:grid-cols-4 gap-4 px-10 mt-2">
...
>
  ...
  {/* Add more options as needed */}
        ...
        <button type="submit" className="w-full p-2 bg-green-500 text-white mb-10 rounded-md" disabled={isSubmitting}>

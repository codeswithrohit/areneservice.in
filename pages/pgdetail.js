      ...
      {isLoading ? (
        ...
        <div className="flex items-start justify-center flex-wrap md:flex-nowrap container mx-auto p-4">
          <div className="w-full md:w-[800px] bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              <h2 className="text-3xl font-semibold text-gray-800 mb-2">{pgdetaildata.PGName}</h2>
          ...
          <div className="mx-2 bg-white h-screen shadow-xl rounded-xl overflow-hidden mt-2 w-full md:w-[380px]">

  ...
  <textarea 
    ...
    <div class="col-span-2">
        <div class="flex flex-wrap items-start pb-4 mb-10 border-b border-gray-200 dark:border-gray-700">
            ...
            <div class="w-full px-4 mb-4 md:w-1/2">
                <p class="mb-1 text-sm font-semibold leading-5 text-gray-600 dark:text-gray-400">Room Price:</p>
                <p class="text-base leading-6 text-gray-800 dark:text-gray-400">Rs.{roomprice}</p>
            </div>
          
            <div class="w-full px-4 mb-4 md:w-1/2">
                <p class="mb-1 text-sm font-semibold leading-5 text-gray-600 dark:text-gray-400">Total Payment:</p>
                <p class="text-base leading-6 text-gray-800 dark:text-gray-400">Rs.{totalPrice}</p>
            </div>
            <div class="w-full px-4 mb-4 md:w-1/2">
                <p class="mb-1 text-sm font-semibold leading-5 text-gray-600 dark:text-gray-400">Total Days:</p>
                <p class="text-base leading-6 text-gray-800 dark:text-gray-400">{totalDays}</p>
            </div>
            <div class="w-full px-4 mb-4 md:w-1/2">
                <p class="mb-1 text-sm font-semibold leading-5 text-gray-600 dark:text-gray-400">Check In - checkOut at:</p>
                <p class="text-base leading-6 text-gray-800 dark:text-gray-400">{checkInDate} - {checkOutDate}</p>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="md:col-span-2">
              ...
              <div class="grid gap-6 sm:grid-cols-2">
                <div class="flex items-center">
                  ...
                  Pay only 500 for Confirmation another payment make at checkin time
                  </label>
                </div>
...
<button onClick={initiatePayment} 
      ...
      Pay now ₹ { (paymentOption === 'oneday' ? 500 : paymentOption)}
    </button>
          </div>
        </div>
      </div>

...
const ResortDetailsViewCard = () => {
  ...
  useEffect(() => {
    ...
    const pgRef = db.collection('Resortdetail').doc(id);
      ...
      {isLoading ? (
        ...
        <div className="flex items-start justify-center flex-wrap md:flex-nowrap container mx-auto p-4">
          <div className="w-full md:w-[800px] bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              <h2 className="text-3xl font-semibold text-gray-800 mb-2">{pgdetaildata.ResortName}</h2>
...
export default ResortDetailsViewCard;

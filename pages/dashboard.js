...
import { FaUser, FaShoppingCart, FaTshirt, FaConciergeBell } from 'react-icons/fa';
  ...
  return (
    <div className='flex flex-col md:flex-row h-screen md:mt-6 mt-28'>
      <div className="bg-gray-800 text-white w-full md:w-64 flex-shrink-0">
        ...
        <ul className="flex flex-wrap md:flex-col md:flex-nowrap space-y-1 md:space-y-0 grid grid-cols-4 md:grid-cols-1 gap-4">
          <li

...
const Signupwithemail = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      // Upload Aadhar Card and PAN Card to Firebase Storage with progress
      ...
      const aadharCardUrl = await uploadFileWithProgress(aadharCard, `aadharCards/${aadharCard.name}`);
      const panCardUrl = await uploadFileWithProgress(panCard, `panCards/${panCard.name}`);
    ...
    <div className='bg-[#e8f0fe]'>
      <div className="flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <div className="w-full max-w-full">
          <p className="text-sm mt-6 text-center">Already have an account? <a href="/signinwithemail" className="text-red-600 font-semibold hover:underline ml-1">Login here</a></p>
          <form className="font-[sans-serif] text-[#333] max-w-4xl mx-auto px-6 my-6">
            <div className="grid sm:grid-cols-2 gap-10">
              <div className="relative flex items-center">
                ...
                <input type="text" placeholder="Enter your name" value={name} onChange={(e) => setName(e.target.value)}
                  className="px-2 pt-5 pb-2 bg-[#e8f0fe] w-full text-sm border-b-2 border-red-600 focus:border-[#333] outline-none" />
              ...
              <div className="relative flex items-center">
                <label className="text-[13px] absolute top-[-10px] left-0 font-semibold">Mobile Number</label>
              ...
              <div className="relative flex items-center ">
                <label className="text-[13px] absolute top-[-10px] left-0 font-semibold">Upload Aadhar Card</label>
                <input
                  type="file"
              ...
              <div className="relative flex items-center ">
                <label className="text-[13px] absolute top-[-10px] left-0 font-semibold">Upload PAN Card</label>
                <input
                  type="file"
              ...
              <div className="relative flex items-center">
                <textarea
                  ...
                  className="p-4 bg-[#e8f0fe] max-w-md mx-auto w-full block text-sm border-2 border-red-600 outline-[#007bff] rounded"
                  rows="4">
                </textarea>
              </div>
            </div>
            <button type="button"
              ...
              disabled={loading}
              className="mt-10 px-2 mb-12 py-2.5 w-full rounded text-sm font-semibold bg-[#333] text-[#e8f0fe] hover:bg-[#222]">
              {loading ? `Uploading... ${uploadProgress.toFixed(2)}%` : 'Submit'}
            </button>
          </form>
        </div>
        <ToastContainer />

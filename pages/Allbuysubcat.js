...
const Allbuysubcat = () => {
    ...
    const applyFilters = (e) => {
      ...
      //   });
        ...
        return isWithinDistance && isPriceInRange  ;
      });
    ...
    const minPrice = 500000; // Define min price
    const maxPrice = 6000000; // Define max price
      ...
      useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const collectionRef = firebase.firestore().collection('buydetail').where('subcat', '==', subcategory).where('Verified', '==', 'true');

...
<div class="mt-6 overflow-x-auto">
  ...
  <tr>
    ...
    <td class="px-3 py-2 whitespace-nowrap">{bookingData.availablegarments}</td>
  ...
  {bookingData && bookingData.orderHistory && (
          <div className="mt-6 overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200 border border-gray-200 rounded-lg">
              ...
              <tbody className="divide-y divide-gray-200">
                {bookingData.orderHistory.map((order, index) => (
                  <tr key={index}>
                    <td className="px-3 py-2 whitespace-nowrap">{order.pickupDate}</td>
                    <td className="px-3 py-2 whitespace-nowrap">{order.garmentCount}</td>
                    <td className="px-3 py-2 whitespace-nowrap">{order.deliverystatus} {order.deliverydatetime}
                    {order.deliverystatus === "Out of Delivery" && (
                  <div>
                    <a href={`/mapviewlaundry?orderId=${bookingData.orderId}`} className="text-green-500 rounded">
                      Track Order
                    </a>
                  </div>
                )}
